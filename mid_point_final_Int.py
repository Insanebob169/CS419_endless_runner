        ...
        def menu(self):
                ...
                while(True):
                        ...
                        if otherChoice == -1:
                                ...
                                message(self, "Other player choose to exit.")
                                return False
                        ...
                        #self.stdscr.addstr(9, 10, "Highscores")
                        #add two to the first number of each addstr after this if highscores option is uncommented
                                ...
                                if choice == 1 or choice == 2:
                                        ...
                                        while(otherChoice == 0):
                                                ...
                                                if otherChoice == -1:
                                                        ...
                                                        otherplayer = 0
                                                elif otherChoice != 3: #concurrent input so make the guest wait 1 seconds and exit the loop
                                                      #and make the host resend the confirmation request
                                                        if s1.status == "guest":
                                                                time.sleep(1)
                                                                otherChoice = 1
